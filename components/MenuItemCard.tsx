    ...
    <div className="group flex flex-col">
      <div className="bg-card rounded-sm aspect-[5/4] mb-6 overflow-hidden relative flex items-center justify-center border border-border/50">
        ...
        <button
          ...
          className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-all duration-300 w-10 h-10 flex items-center justify-center bg-white rounded-full shadow-lg hover:bg-foreground hover:text-background"
        >
